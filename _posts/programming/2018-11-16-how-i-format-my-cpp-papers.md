...
<tr>
<th markdown="1">
[P0655R1.md](https://github.com/mpark/wg21/blob/master/P0655R1.md)
</th>
<th markdown="1">
[P0655R1.pdf][P0655R1]
</th>
...
in the [`data`][data] directory. Given a [Pandoc Markdown] file
`<paper>.md` at the top-level, `make <paper>.pdf` generates PDF document via
LaTeX at `generated/<paper>.pdf` and `make <paper>.html` generates
...
[data]: https://github.com/mpark/wg21/tree/master/data
...
be explicitly set via `toc: true` in the YAML metadata block.

<table>
<thead>
<tr>
<th markdown="1">
[P1260R0.md](https://github.com/mpark/wg21/blob/master/P1260R0.md)
</th>
<th markdown="1">
[P1260R0.pdf][P1260R0]
</th>
